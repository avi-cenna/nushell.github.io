...
</code></pre></div><h2 id="splitting-strings" tabindex="-1"><a class="header-anchor" href="#splitting-strings" aria-hidden="true">#</a> Splitting strings</h2>`,10),g=s("code",null,"split row",-1),m=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token string">&quot;red,green,blue&quot;</span> <span class="token operator">|</span> <span class="token function">split</span> row <span class="token string">&quot;,&quot;</span>
╭───┬───────╮
│ <span class="token number">0</span> │ red   │
│ <span class="token number">1</span> │ green │
│ <span class="token number">2</span> │ blue  │
╰───┴───────╯
</code></pre></div>`,1),k=s("code",null,"split column",-1),b=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token string">&quot;red,green,blue&quot;</span> <span class="token operator">|</span> <span class="token function">split</span> <span class="token function">column</span> <span class="token string">&quot;,&quot;</span>
╭───┬─────────┬─────────┬─────────╮
│ <span class="token comment"># │ column1 │ column2 │ column3 │</span>
├───┼─────────┼─────────┼─────────┤
│ <span class="token number">0</span> │ red     │ green   │ blue    │
╰───┴─────────┴─────────┴─────────╯
</code></pre></div>`,1),f=s("code",null,"split chars",-1),_=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token string">&#39;aeiou&#39;</span> <span class="token operator">|</span> <span class="token function">split</span> chars
╭───┬───╮
...
╰───┴───╯
</code></pre></div>`,1),x={id:"the-str-command",tabindex:"-1"},v=s("a",{class:"header-anchor",href:"#the-str-command","aria-hidden":"true"},"#",-1),w=s("code",null,"str",-1),y=s("code",null,"str",-1),q=s("code",null,"help str",-1),N=s("code",null,"str contains",-1),T=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token string">&quot;hello world&quot;</span> <span class="token operator">|</span> str contains <span class="token string">&quot;o wo&quot;</span>
<span class="token boolean">true</span>
</code></pre></div><p>(You might also prefer, for brevity, the <code>=~</code> operator (described below).)</p><h3 id="trimming-strings" tabindex="-1"><a class="header-anchor" href="#trimming-strings" aria-hidden="true">#</a> Trimming strings</h3>`,3),S=s("code",null,"str trim",-1),C=s("code",null,"str trim",-1),$=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token string">&#39;       My   string   &#39;</span> <span class="token operator">|</span> str trim
My   string
...
o Wo
</code></pre></div><h3 id="string-padding" tabindex="-1"><a class="header-anchor" href="#string-padding" aria-hidden="true">#</a> String padding</h3>`,9),A=s("code",null,"fill",-1),F=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token string">&#39;1234&#39;</span> <span class="token operator">|</span> fill <span class="token parameter variable">-a</span> right <span class="token parameter variable">-c</span> <span class="token string">&#39;0&#39;</span> <span class="token parameter variable">-w</span> <span class="token number">10</span>
0000001234
<span class="token operator">&gt;</span> <span class="token string">&#39;1234&#39;</span> <span class="token operator">|</span> fill <span class="token parameter variable">-a</span> left <span class="token parameter variable">-c</span> <span class="token string">&#39;0&#39;</span> <span class="token parameter variable">-w</span> <span class="token number">10</span> <span class="token operator">|</span> str length
<span class="token number">10</span>
</code></pre></div><h3 id="reversing-strings" tabindex="-1"><a class="header-anchor" href="#reversing-strings" aria-hidden="true">#</a> Reversing strings</h3>`,2),B=s("code",null,"str reverse",-1),P=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token string">&#39;Nushell&#39;</span> <span class="token operator">|</span> str reverse
llehsuN
...
╰───┴──────────┴────────────╯
</code></pre></div>`,1),Y=s("code",null,"from csv",-1),W=s("code",null,"from tsv",-1),H=s("code",null,"from ssv",-1),M=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token string">&quot;acronym,long<span class="token entity" title="\\n">\\n</span>APL,A Programming Language&quot;</span> <span class="token operator">|</span> from csv
╭───┬─────────┬────────────────────────╮
...
<span class="token boolean">true</span>
</code></pre></div><h2 id="converting-strings" tabindex="-1"><a class="header-anchor" href="#converting-strings" aria-hidden="true">#</a> Converting strings</h2><p>There are multiple ways to convert strings to and from other types.</p><h3 id="to-string" tabindex="-1"><a class="header-anchor" href="#to-string" aria-hidden="true">#</a> To string</h3>`,10),R=s("code",null,"into string",-1),U=s("code",null,"123 | into string",-1),X=s("li",null,[a("Using string interpolation. e.g. "),s("code",null,"$'(123)'")],-1),j=s("code",null,"build-string",-1),J=s("code",null,"build-string (123)",-1),O=s("h3",{id:"from-string",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#from-string","aria-hidden":"true"},"#"),a(" From string")],-1),V=s("code",null,"into <type>",-1),D=s("code",null,"'123' | into int",-1),I=s("h2",{id:"coloring-strings",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#coloring-strings","aria-hidden":"true"},"#"),a(" Coloring strings")],-1),z=s("code",null,"ansi",-1),Q=s("div",{class:"language-bash","data-ext":"sh"},[s("pre",{class:"language-bash"},[s("code",null,[s("span",{class:"token operator"},">"),a(),s("span",{class:"token string"},"$'(ansi purple_bold)This text is a bold purple!(ansi reset)'"),a(`
`)])])],-1),G=s("p",null,[s("code",null,"ansi purple_bold"),a(" makes the text a bold purple "),s("code",null,"ansi reset"),a(" resets the coloring to the default. (Tip: You should always end colored strings with "),s("code",null,"ansi reset"),a(")")],-1);function K(Z,ss){const n=l("RouterLink");return i(),c("div",null,[d,s("p",null,[a("You can also use the "),e(n,{to:"/commands/docs/run-external.html"},{default:t(()=>[h]),_:1}),a(" command for this purpose, which provides additional flags and options.")]),u,s("p",null,[a("The "),e(n,{to:"/commands/docs/split_row.html"},{default:t(()=>[g]),_:1}),a(" command creates a list from a string based on a delimiter.")]),m,s("p",null,[a("The "),e(n,{to:"/commands/docs/split_column.html"},{default:t(()=>[k]),_:1}),a(" command will create a table from a string based on a delimiter. This applies generic column names to the table.")]),b,s("p",null,[a("Finally, the "),e(n,{to:"/commands/docs/split_chars.html"},{default:t(()=>[f]),_:1}),a(" command will split a string into a list of characters.")]),_,s("h2",x,[v,a(" The "),e(n,{to:"/commands/docs/str.html"},{default:t(()=>[w]),_:1}),a(" command")]),s("p",null,[a("Many string functions are subcommands of the "),e(n,{to:"/commands/docs/str.html"},{default:t(()=>[y]),_:1}),a(" command. You can get a full list using "),q,a(".")]),s("p",null,[a("For example, you can look if a string contains a particular substring using "),e(n,{to:"/commands/docs/str_contains.html"},{default:t(()=>[N]),_:1}),a(":")]),T,s("p",null,[a("You can trim the sides of a string with the "),e(n,{to:"/commands/docs/str_trim.html"},{default:t(()=>[S]),_:1}),a(" command. By default, the "),e(n,{to:"/commands/docs/str_trim.html"},{default:t(()=>[C]),_:1}),a(" commands trims whitespace from both sides of the string. For example:")]),$,s("p",null,[a("With the "),e(n,{to:"/commands/docs/fill.html"},{default:t(()=>[A]),_:1}),a(" command you can add padding to a string. Padding adds characters to string until it's a certain length. For example:")]),F,s("p",null,[a("This can be done easily with the "),e(n,{to:"/commands/docs/str_reverse.html"},{default:t(()=>[B]),_:1}),a(" command.")]),P,s("p",null,[a("With the "),e(n,{to:"/commands/docs/parse.html"},{default:t(()=>[E]),_:1}),a(" command you can parse a string into columns. For example:")]),L,s("p",null,[a("If a string is known to contain comma-separated, tab-separated or multi-space-separated data, you can use "),e(n,{to:"/commands/docs/from_csv.html"},{default:t(()=>[Y]),_:1}),a(", "),e(n,{to:"/commands/docs/from_tsv.html"},{default:t(()=>[W]),_:1}),a(" or "),e(n,{to:"/commands/docs/from_ssv.html"},{default:t(()=>[H]),_:1}),a(":")]),M,s("ol",null,[s("li",null,[a("Using "),e(n,{to:"/commands/docs/into_string.html"},{default:t(()=>[R]),_:1}),a(". e.g. "),U]),X,s("li",null,[a("Using "),e(n,{to:"/commands/docs/build-string.html"},{default:t(()=>[j]),_:1}),a(". e.g. "),J])]),O,s("ol",null,[s("li",null,[a("Using "),e(n,{to:"/commands/docs/into.html"},{default:t(()=>[V]),_:1}),a(". e.g. "),D])]),I,s("p",null,[a("You can color strings with the "),e(n,{to:"/commands/docs/ansi.html"},{default:t(()=>[z]),_:1}),a(" command. For example:")]),Q,G])}const ns=r(p,[["render",K],["__file","working_with_strings.html.vue"]]);export{ns as default};
