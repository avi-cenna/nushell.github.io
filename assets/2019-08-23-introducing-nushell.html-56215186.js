...
---+------------------------------
</code></pre></div><p>Next, we can create our columns by splitting each row at the pipe (<code>|</code>) symbol:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; open people.psv | lines | split-column &quot;|&quot;
---+----------+-----------+-----------
...
---+----------+-----------+-----------
 ...
 2 | Antonio  |  Vivaldi  |  Composer
---+----------+-----------+-----------
</code></pre></div><p>That&#39;s already good enough that we can work with the data. We can go a step further and name the columns if we want:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; open people.psv | lines | split-column &quot; | &quot; firstname lastname job
---+-----------+----------+----------
...
---+-----------+----------+----------
 ...
 2 | Antonio   | Vivaldi  | Composer
---+-----------+----------+----------
</code></pre></div><p>But what about working with commands outside of Nu? Let&#39;s first call the native version of <code>ls</code> instead of the Nu version:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ^ls
...
</code></pre></div><p>We&#39;ll use the same commands we used on data to bring it into Nu:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>^ls | split-row &quot; &quot; file
----+---------------
 #  | value
----+---------------
 0  | assets
 ...
 16 | tests
----+---------------
</code></pre></div><p>Or maybe we want to work with the native <code>ls -la</code>:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>^ls -la | lines | split-column &quot; &quot;
----+------------+---------+----------+----------+---------+---------+---------+---------+---------------
...
----+------------+---------+----------+----------+---------+---------+---------+---------+---------------
</code></pre></div><p>After a bit of experimenting, we might come up with a command like this:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ^ls -la | lines | skip 1 | split-column &quot; &quot; perms files group user size month day time name
----+------------+-------+----------+----------+--------+-------+-----+-------+---------------
...
---+---+--------------------------------------------+-------------------------------
</code></pre></div><p>That&#39;s right, we&#39;re in the file. Can we <code>cd</code>? Oh yes, we can:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>/&gt; ls
------------+--------------+------------------+----------+----------
 bin        | dependencies | dev-dependencies | lib      | package
------------+--------------+------------------+----------+----------
 [11 items] | [object]     | [object]         | [object] | [object]
...
----+----------------------+---------------------------
 ...
 10 | nu                   | src/main.rs
----+----------------------+---------------------------
</code></pre></div><h1 id="plugins" tabindex="-1"><a class="header-anchor" href="#plugins" aria-hidden="true">#</a> Plugins</h1>`,12),E={href:"https://www.nushell.sh/book/plugins.html",target:"_blank",rel:"noopener noreferrer"},S=t("h1",{id:"all-because-of-rust",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#all-because-of-rust","aria-hidden":"true"},"#"),e(" All because of Rust")],-1),T=t("p",null,'Nu would not have been possible without Rust. Internally, it uses async/await, async streams, and liberal use of "serde" to manage serializing and deserializing into the common data format and to communicate with plugins.',-1),B={href:"https://crates.io",target:"_blank",rel:"noopener noreferrer"},J=t("strong",null,"huge",-1),q=t("h1",{id:"what-s-next",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#what-s-next","aria-hidden":"true"},"#"),e(" What's next?")],-1),M=t("p",null,"Nu is just getting started. In this release, we have a foundation to build on. Next, we'll work towards stability, the ability to use Nu as your main shell, the ability to write functions and scripts in Nu, and much more.",-1),R={href:"https://book.nushell.sh/en/installation",target:"_blank",rel:"noopener noreferrer"},O={href:"https://discord.gg/NtAbbGn",target:"_blank",rel:"noopener noreferrer"},z={href:"https://github.com/nushell/nushell",target:"_blank",rel:"noopener noreferrer"};function L(P,V){const n=s("ExternalLinkIcon");return i(),l("div",null,[x,b,t("p",null,[e("It's called Nushell, or just Nu for short. We have a "),t("a",j,[e("book"),a(n)]),e(" (¡también se habla "),t("a",_,[e("Español"),a(n)]),e("!). We have a "),t("a",y,[e("repo"),a(n)]),e(".")]),v,t("p",null,[e("Nu takes heavy inspiration from the "),t("a",k,[e("error messages in Rust"),a(n)]),e(". As much as possible, draw your eyes to the problem.")]),A,N,t("p",null,[e("You might wonder how does that even work. Nu has a metadata system (still early!) that you can read about in the "),t("a",C,[e("Metadata chapter"),a(n)]),e(" of the "),t("a",I,[e("Nu book"),a(n)]),e(". Let's just take a quick peek at it:")]),W,t("p",null,[e("Nu can't come with everything you might want to do with it, so we're releasing Nu with the ability to extend it with plugins. There's more information in the "),t("a",E,[e("plugins chapters"),a(n)]),e(". Nu will look for these plugins in your path, and load them up on startup.")]),S,T,t("p",null,[e("We also heavily leveraged "),t("a",B,[e("crates.io"),a(n)]),e(". The ability to load numerous file formats, display messages, draw tables, and more all came from the hundreds (thousands?) of generous developers who wrote the crates we use in Nu. A "),J,e(" thank you to everyone who contributed to Nu without ever knowing it.")]),q,M,t("p",null,[e("If you want to give it a spin, the "),t("a",R,[e("installation instructions"),a(n)]),e(" will help you get started. If you want to chat come by our "),t("a",O,[e("discord"),a(n)]),e(" and "),t("a",z,[e("github"),a(n)])])])}const D=r(f,[["render",L],["__file","2019-08-23-introducing-nushell.html.vue"]]);export{D as default};
