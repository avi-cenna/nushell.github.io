...
</code></pre></div><p><code>sys</code>は Nu が実行されているシステムに関する情報を提供します。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> sys <span class="token operator">|</span> table
╭───────┬───────────────────╮
