...
╰───┴──────┴───────┴─────┴──────┴────────┴────────┴──────────╯
</code></pre></div><p>Ejecutando <code>sys</code> devuelve información sobre el sistema en el que se ejecuta Nu:</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> sys <span class="token operator">|</span> table
╭───────┬───────────────────╮
...
</code></pre></div>`,36),p=[t];function c(l,r){return s(),n("div",null,p)}const i=a(o,[["render",c],["__file","index.html.vue"]]);export{i as default};
