import{_ as s,M as d,p as i,q as c,Q as e,t as a,N as n,U as o,a1 as l}from"./framework-344bb0e4.js";const r={},u=e("h1",{id:"custom-commands",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#custom-commands","aria-hidden":"true"},"#"),a(" Custom commands")],-1),p=e("p",null,"Nu's ability to compose long pipelines allows you a lot of control over your data and system, but it comes at the price of a lot of typing. Ideally, you'd be able to save your well-crafted pipelines to use again and again.",-1),h=e("p",null,"This is where custom commands come in.",-1),m=e("p",null,"An example definition of a custom command:",-1),g=e("div",{class:"language-nushell","data-ext":"nushell"},[e("pre",{class:"language-nushell"},[e("code",null,`def greet [name] {
  ['hello' $name]
}
`)])],-1),f={class:"custom-container tip"},v=e("p",{class:"custom-container-title"},"TIP",-1),x=e("code",null,"'hello'",-1),w=e("code",null,"$name",-1),y=e("code",null,"null",-1),b=e("code",null,"ignore",-1),_=e("code",null,"['hello' $name] | null",-1),$=e("code",null,"save",-1),q=e("code",null,"cd",-1),k=e("code",null,"null",-1),T=l(`<p>In this definition, we define the <code>greet</code> command, which takes a single parameter <code>name</code>. Following this parameter is the block that represents what will happen when the custom command runs. When called, the custom command will set the value passed for <code>name</code> as the <code>$name</code> variable, which will be available to the block.</p><p>To run the above, we can call it like we would call built-in commands:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; greet &quot;world&quot;
...
</code></pre></div>`,70),j=e("code",null,"help",-1),A=l(`<div class="custom-container warning"><p class="custom-container-title">Note</p><p>A Nushell comment that continues on the same line for argument documentation purposes requires a space before the <code> #</code> pound sign.</p></div><p>Now, if we run <code>help greet</code>, we&#39;re given a more helpful help text:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>A greeting command that can greet the caller
...
</code></pre></div>`,6),W=e("code",null,"ls",-1),O=e("div",{class:"language-nushell","data-ext":"nushell"},[e("pre",{class:"language-nushell"},[e("code",null,`def my-ls [] { ls }
`)])],-1),C=e("code",null,"ls",-1),Y=l(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; my-ls | get name
───┬───────────────────────
 0 │ myscript.nu
 1 │ myscript2.nu
