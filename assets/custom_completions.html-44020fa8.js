...
</code></pre></div><h2 id="external-completions" tabindex="-1"><a class="header-anchor" href="#external-completions" aria-hidden="true">#</a> External completions</h2>`,7),E=e("code",null,"external_completer",-1),I=e("code",null,"config.nu",-1),C={href:"https://github.com/rsteube/carapace-bin",target:"_blank",rel:"noopener noreferrer"},L=s(`<p>This example should enable carapace external completions:</p><div class="language-nu" data-ext="nu"><pre class="language-nu"><code># config.nu
