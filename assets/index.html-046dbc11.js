import{_ as o,M as l,p as c,q as u,Q as s,t as n,N as e,U as t,a1 as p}from"./framework-344bb0e4.js";const r={},i=s("h1",{id:"介绍",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#介绍","aria-hidden":"true"},"#"),n(" 介绍")],-1),d=s("p",null,"你好，欢迎来到 Nushell 项目。这个项目的目标是继承 Unix Shell 中用管道把简单的命令连接在一起的理念，并将其带到更具现代风格的开发中。",-1),m=s("p",null,"Nu 汲取了很多常见领域的灵感：传统 Shell 比如 Bash、基于对象的 Shell 比如 PowerShell、逐步类型化的语言比如 TypeScript、函数式编程、系统编程，等等。但是，Nu 并不试图成为万金油，而是把精力集中在做好这几件事上:",-1),k=s("ul",null,[s("li",null,"作为一个具有现代感的灵活的跨平台 Shell；"),s("li",null,"作为一种现代的编程语言，解决与数据有关的问题；"),s("li",null,"给予清晰的错误信息和干净的 IDE 支持；")],-1),h=s("p",null,"了解 Nu 能做什么的最简单的方法是从一些例子开始，所以让我们深入了解一下。",-1),b=s("code",null,"ls",-1),_=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">ls</span>
╭────┬───────────────────────┬──────┬───────────┬─────────────╮
...
</code></pre></div><p>该表不仅仅是以不同的方式显示目录，就像电子表格中的表一样，它还允许我们以更加互动的方式来处理数据。</p>`,2),g=s("code",null,"ls",-1),f=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">ls</span> <span class="token operator">|</span> sort-by size <span class="token operator">|</span> reverse
╭────┬───────────────────────┬──────┬───────────┬─────────────╮
│ <span class="token comment">#  │         name          │ type │   size    │  modified   │</span>
├────┼───────────────────────┼──────┼───────────┼─────────────┤
...
<span class="token punctuation">..</span>.
</code></pre></div>`,1),v=s("code",null,"ls",-1),y=s("code",null,"sort-by",-1),B=s("code",null,"ls",-1),x=s("code",null,"reverse",-1),N=s("code",null,"ls",-1),S=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">ls</span> <span class="token operator">|</span> where size <span class="token operator">&gt;</span> 1kb
╭───┬───────────────────┬──────┬─────────┬────────────╮
│ <span class="token comment"># │       name        │ type │  size   │  modified  │</span>
├───┼───────────────────┼──────┼─────────┼────────────┤
...
╭─────┬───────┬───────┬──────────────────────────────────────────────┬─────────┬───────┬──────────┬──────────╮
│   <span class="token comment"># │  pid  │ ppid  │                     name                     │ status  │  cpu  │   mem    │ virtual  │</span>
├─────┼───────┼───────┼──────────────────────────────────────────────┼─────────┼───────┼──────────┼──────────┤
│   <span class="token number">0</span> │ <span class="token number">87194</span> │     <span class="token number">1</span> │ mdworker_shared                              │ Sleep   │  <span class="token number">0.00</span> │  <span class="token number">25.9</span> MB │ <span class="token number">418.0</span> GB │
│   <span class="token number">1</span> │ <span class="token number">87183</span> │  <span class="token number">2314</span> │ Arc Helper <span class="token punctuation">(</span>Renderer<span class="token punctuation">)</span>                        │ Sleep   │  <span class="token number">0.00</span> │  <span class="token number">59.9</span> MB │   <span class="token number">1.6</span> TB │
│   <span class="token number">2</span> │ <span class="token number">87182</span> │  <span class="token number">2314</span> │ Arc Helper <span class="token punctuation">(</span>Renderer<span class="token punctuation">)</span>                        │ Sleep   │  <span class="token number">0.23</span> │ <span class="token number">224.3</span> MB │   <span class="token number">1.6</span> TB │
│   <span class="token number">3</span> │ <span class="token number">87156</span> │ <span class="token number">87105</span> │ Code Helper <span class="token punctuation">(</span>Plugin<span class="token punctuation">)</span>                         │ Sleep   │  <span class="token number">0.00</span> │  <span class="token number">56.0</span> MB │ <span class="token number">457.4</span> GB │
<span class="token punctuation">..</span>.
</code></pre></div>`,3),G=s("code",null,"ps",-1),w=s("code",null,"ls",-1),M=s("code",null,"ps",-1),C=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">ps</span> <span class="token operator">|</span> where cpu <span class="token operator">&gt;</span> <span class="token number">5</span>
╭───┬───────┬───────┬─────────────────────────────────────────┬─────────┬───────┬──────────┬──────────╮
│ <span class="token comment"># │  pid  │ ppid  │                  name                   │ status  │  cpu  │   mem    │ virtual  │</span>
├───┼───────┼───────┼─────────────────────────────────────────┼─────────┼───────┼──────────┼──────────┤
│ <span class="token number">0</span> │ <span class="token number">86759</span> │ <span class="token number">86275</span> │ nu                                      │ Running │  <span class="token number">6.27</span> │  <span class="token number">38.7</span> MB │ <span class="token number">419.7</span> GB │
│ <span class="token number">1</span> │ <span class="token number">89134</span> │     <span class="token number">1</span> │ com.apple.Virtualization.VirtualMachine │ Running │ <span class="token number">23.92</span> │   <span class="token number">1.5</span> GB │ <span class="token number">427.3</span> GB │
│ <span class="token number">2</span> │ <span class="token number">70414</span> │     <span class="token number">1</span> │ VTDecoderXPCService                     │ Sleep   │ <span class="token number">19.04</span> │  <span class="token number">17.5</span> MB │ <span class="token number">419.7</span> GB │
│ <span class="token number">3</span> │  <span class="token number">2334</span> │     <span class="token number">1</span> │ TrackpadExtension                       │ Sleep   │  <span class="token number">7.47</span> │  <span class="token number">25.3</span> MB │ <span class="token number">418.8</span> GB │
│ <span class="token number">4</span> │  <span class="token number">1205</span> │     <span class="token number">1</span> │ iTerm2                                  │ Sleep   │ <span class="token number">11.92</span> │ <span class="token number">657.2</span> MB │ <span class="token number">421.7</span> GB │
╰───┴───────┴───────┴─────────────────────────────────────────┴─────────┴───────┴──────────┴──────────╯
</code></pre></div>`,1),T=s("code",null,"ls",-1),E=s("code",null,"ps",-1),U=s("code",null,"date",-1),K=s("code",null,"sys",-1),R=p(`<p>运行<code>date now</code>输出关于当前日期和时间的信息：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">date</span> now
...
╰───┴──────┴───────┴─────┴──────┴────────┴────────┴──────────╯
</code></pre></div>`,4),A=s("code",null,"sys",-1),j=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> sys <span class="token operator">|</span> table
╭───────┬───────────────────╮
...
╰───────┴───────────────────╯
</code></pre></div>`,1),I=s("code",null,"sys",-1),z=s("em",null,[s("code",null,"get")],-1),L=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> sys <span class="token operator">|</span> get <span class="token function">host</span>
╭────────────────┬────────────────────────╮
...
╰────────────────┴────────────────────────╯
</code></pre></div>`,1),V=s("code",null,"get",-1),P=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> sys <span class="token operator">|</span> get host.sessions.name
╭───┬────╮
│ <span class="token number">0</span> │ jt │
╰───┴────╯
</code></pre></div><p>现在，系统中只有一个名为 &quot;jt&quot; 的用户。你会注意到，我们可以传递一个列路径（<code>host.sessions.name</code>部分），而不仅仅是简单的列名称。Nu 会接受列路径并输出表中相应的数据。</p><p>你可能已经注意到其他一些不同之处：我们没有一个数据表，而只有一个元素：即字符串 &quot;jt&quot;。Nu 既能处理数据表，也能处理字符串。字符串是使用 Nu 外部命令的一个重要部分。</p>`,3),q=s("code",null,"echo",-1),D=s("code",null,"^",-1),H=s("code",null,"echo",-1),F=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> sys <span class="token operator">|</span> get host.sessions.name <span class="token operator">|</span> each <span class="token punctuation">{</span> <span class="token operator">|</span>it<span class="token operator">|</span> ^echo <span class="token variable">$it</span> <span class="token punctuation">}</span>
jt
</code></pre></div><p>敏锐的读者可能会发现这看起来和我们之前的非常相似！确实如此，但有一个重要的区别：我们用前面的值调用了<code>^echo</code>。这允许我们把数据从 Nu 中传到外部命令<code>echo</code>（或者 Nu 之外的任何命令，比如<code>git</code>）。</p><h3 id="获取帮助" tabindex="-1"><a class="header-anchor" href="#获取帮助" aria-hidden="true">#</a> 获取帮助</h3>`,3),O=s("code",null,"help",-1),Y=s("code",null,"help commands",-1),J=s("code",null,"help -f <topic>",-1),Q=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token builtin class-name">help</span> path
...
</code></pre></div>`,1);function W(X,$){const a=l("RouterLink");return c(),u("div",null,[i,d,m,k,h,s("p",null,[n("当你运行"),e(a,{to:"/commands/docs/ls.html"},{default:t(()=>[b]),_:1}),n("这样的命令时，你会注意到的第一件事是，你得到的不是一个文本块，而是一个结构化的表格：")]),_,s("p",null,[n("我们要做的第一件事是按大小对我们的表进行排序。要做到这一点，我们将从"),e(a,{to:"/commands/docs/ls.html"},{default:t(()=>[g]),_:1}),n("中获取输出，并将其输入到一个可以根据列的内容对表进行排序的命令中：")]),f,s("p",null,[n("你可以看到，为了达到这个目的，我们没有向"),e(a,{to:"/commands/docs/ls.html"},{default:t(()=>[v]),_:1}),n("传递命令行参数。取而代之的是，我们使用了 Nu 提供的"),y,n("命令来对"),e(a,{to:"/commands/docs/ls.html"},{default:t(()=>[B]),_:1}),n("命令的输出进行排序。为了在顶部看到最大的文件，我们还使用了"),e(a,{to:"/commands/docs/reverse.html"},{default:t(()=>[x]),_:1}),n("命令。")]),s("p",null,[n("Nu 提供了许多可以对表进行操作的命令，例如，我们可以过滤"),e(a,{to:"/commands/docs/ls.html"},{default:t(()=>[N]),_:1}),n("表的内容，使其只显示超过 1 千字节的文件。")]),S,s("p",null,[n("如果你使用过 Linux，你可能对"),e(a,{to:"/commands/docs/ps.html"},{default:t(()=>[G]),_:1}),n("命令很熟悉。通过它，我们可以得到一个当前系统正在运行的所有进程的列表，它们的状态是什么，以及它们的名字是什么，我们还可以看到这些进程的 CPU 负载。")]),s("p",null,[n("如果我们想显示那些正在活跃使用 CPU 的进程呢？就像我们之前对"),e(a,{to:"/commands/docs/ls.html"},{default:t(()=>[w]),_:1}),n("命令所做的那样，我们也可以利用"),e(a,{to:"/commands/docs/ps.html"},{default:t(()=>[M]),_:1}),n("命令返回给我们的表格来做到：")]),C,s("p",null,[n("到目前为止，我们一直在使用"),e(a,{to:"/commands/docs/ls.html"},{default:t(()=>[T]),_:1}),n("和"),e(a,{to:"/commands/docs/ps.html"},{default:t(()=>[E]),_:1}),n("来列出文件和进程。Nu 还提供了其他可以创建有用信息表格的命令。接下来，让我们试一下"),e(a,{to:"/commands/docs/date.html"},{default:t(()=>[U]),_:1}),n("和"),e(a,{to:"/commands/docs/sys.html"},{default:t(()=>[K]),_:1}),n("。")]),R,s("p",null,[n("运行"),e(a,{to:"/commands/docs/sys.html"},{default:t(()=>[A]),_:1}),n("可以得到 Nu 所运行的系统的信息：")]),j,s("p",null,[n("这与我们之前看到的表格有些不同。"),e(a,{to:"/commands/docs/sys.html"},{default:t(()=>[I]),_:1}),n("命令输出了一个在单元格中包含结构化表格而非简单值的表格。要查看这些数据，我们需要 "),z,n(" 待查看的列：")]),L,s("p",null,[e(a,{to:"/commands/docs/get.html"},{default:t(()=>[V]),_:1}),n('命令让我们深入表的某一列内容中。在这里，我们要查看的是 "host" 列，它包含了 Nu 正在运行的主机的信息：操作系统名称、主机名、CPU，以及更多。让我们来获取系统上的用户名：')]),P,s("p",null,[n("让我们看看字符串在 Nu 外部命令里面是如何工作的。我们以之前的例子为例，运行外部的"),q,n("命令（"),D,n("告诉 Nu 不要使用内置的"),e(a,{to:"/commands/docs/echo.html"},{default:t(()=>[H]),_:1}),n("命令）：")]),F,s("p",null,[n("任何 Nu 的内置命令的帮助文本都可以通过"),e(a,{to:"/commands/docs/help.html"},{default:t(()=>[O]),_:1}),n("命令来找到。要查看所有命令，请运行"),Y,n("。你也可以通过执行"),J,n("来搜索一个主题：")]),Q])}const ss=o(r,[["render",W],["__file","index.html.vue"]]);export{ss as default};
