import{_ as r,M as i,p as s,q as d,Q as t,t as e,N as n,R as l,a1 as o}from"./framework-344bb0e4.js";const c="/assets/0_60_completions-cbb2312c.gif",h="/assets/0_60_ls_colors-26b3f717.png",u="/assets/0_59_1_for_multiline_indicator-d6a96b87.png",p="/assets/0_59_1_ls_gridc-19b31dd9.png",g="/assets/0_60_miette-5e9b76d4.png",m="/assets/0_60_0_completions_internal-dd160e9f.gif",f="/assets/0_60_0_history-b2361588.gif",w="/assets/0_60_0_history_complete-5c625fca.gif",b={},y={href:"https://war.ukraine.ua",target:"_blank",rel:"noopener noreferrer"},x=t("h1",{id:"nushell-0-60",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#nushell-0-60","aria-hidden":"true"},"#"),e(" Nushell 0.60")],-1),v=t("p",null,"Nushell, or Nu for short, is a new shell that takes a modern, structured approach to your commandline. It works seamlessly with the data from your filesystem, operating system, and a growing number of file formats to make it easy to build powerful commandline pipelines.",-1),k=t("p",null,"Today, we're releasing a beta release of 0.60 of Nu. This is an enormous release, with lots of changes across all aspects of Nushell.",-1),_=t("h1",{id:"where-to-get-it",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#where-to-get-it","aria-hidden":"true"},"#"),e(" Where to get it")],-1),N={href:"https://github.com/nushell/nushell/releases/tag/0.60.0",target:"_blank",rel:"noopener noreferrer"},q={href:"https://crates.io/crates/nu",target:"_blank",rel:"noopener noreferrer"},T=t("code",null,"cargo install nu",-1),$=o('<p>If you want all the built-in goodies, you can install <code>cargo install nu --all-features</code>.</p><p>As part of this release, we also publish a set of optional plugins you can install and use with Nu. To install, use <code>cargo install nu_plugin_&lt;plugin name&gt;</code>.</p><h1 id="party-🥳" tabindex="-1"><a class="header-anchor" href="#party-🥳" aria-hidden="true">#</a> Party! 🥳</h1><p>It&#39;s here! 🎉🎉</p><p>We&#39;re excited to announce the first full release of Nushell using the new engine, new line editor, and so much more!</p><h1 id="skipping-versions" tabindex="-1"><a class="header-anchor" href="#skipping-versions" aria-hidden="true">#</a> Skipping versions</h1><p>The first thing you&#39;ll notice is that we&#39;re skipping from version 0.44 to 0.60. This is on purpose, you didn&#39;t miss anything!</p><p>Because of the number of changes, and the number of breaking changes, we wanted to let everyone know how much has changed by also making a big jump in the version number. Previous scripts will need to be updated, and you&#39;ll need to learn some of the new ways of doing things in Nushell to get back to your same level of comfort.</p><p>Let&#39;s talk about the features new in this release.</p><h1 id="custom-completions" tabindex="-1"><a class="header-anchor" href="#custom-completions" aria-hidden="true">#</a> Custom completions</h1><p><img src="'+c+`" alt="Custom completions for git and winget"></p><p>Let&#39;s start with Nushell&#39;s most-requested feature: custom completions. The long-awaited, long-requested feature of having nice completions is finally here. With 0.60, you&#39;ll be able to write scripts that help you complete parameters and flag values. Let&#39;s take a look at an example. When you create a new config, you&#39;ll see a section like this:</p><div class="language-text" data-ext="text"><pre class="language-text"><code># This is a simplified version of completions for git branches and git remotes
...
│  5 │ blog              │
...
</code></pre></div><p>You can now also use <code>select</code> on rows, by passing in a row number:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ls | select 1
╭───┬─────────────────┬──────┬───────┬────────────╮
│ # │      name       │ type │ size  │  modified  │
├───┼─────────────────┼──────┼───────┼────────────┤
│ 0 │ CONTRIBUTING.md │ file │ 389 B │ 2 days ago │
╰───┴─────────────────┴──────┴───────┴────────────╯
</code></pre></div><h3 id="get-ing-data" tabindex="-1"><a class="header-anchor" href="#get-ing-data" aria-hidden="true">#</a> <code>Get</code>-ing data</h3><p>The other fundamental command for working with tables is <code>get</code>. Like <code>select</code>, <code>get</code> allows you to work with columns and rows in a table, or fields in a record. Unlike <code>select</code>, the <code>get</code> command extracts data out of the table and does not try to preserve its original form. This is helpful when you want to get at the cell data itself.</p><p>Via a column:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ls | get name
╭────┬───────────────────╮
│  0 │ CNAME             │
│  1 │ CONTRIBUTING.md   │
│  2 │ LICENSE           │
...
│  5 │ blog              │
...
</code></pre></div><p>Via a row:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; ls | get 1
╭──────────┬─────────────────╮
...
use greetings greet
greet
</code></pre></div><p>You can also make modules from whole files. We can rewrite the above using a separate file:</p><div class="language-text" data-ext="text"><pre class="language-text"><code># greetings.nu
export def greet [] {
  print &quot;hello!&quot;
}
...
greet
</code></pre></div><p>Modules allow you to <code>export</code> custom commands and environment variables to be used in other places.</p><h2 id="make-your-own-errors" tabindex="-1"><a class="header-anchor" href="#make-your-own-errors" aria-hidden="true">#</a> Make your own errors</h2><p>You can also create your own error messages in your custom commands and send these back to the user if they call your command in the wrong way. For example, let&#39;s say you wanted to require that the user pass in a value between 1 and 10:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; def one-to-ten [x: int] {
...
│ 85 │ Ștefan                          │
╰────┴─────────────────────────────────╯
</code></pre></div><h1 id="looking-ahead" tabindex="-1"><a class="header-anchor" href="#looking-ahead" aria-hidden="true">#</a> Looking ahead</h1><p>With 0.60, we have a solid foundation to build on to reach 1.0. The cleaner architecture and improvements to the language will make way for future improvements, like pattern matching, tasks, and more.</p>`,5);function D(P,Y){const a=i("ExternalLinkIcon");return s(),d("div",null,[t("p",null,[t("em",null,[e("Before we begin, as the Russian invasion of Ukraine still continues to threaten lives, "),t("a",y,[e("here"),n(a)]),e(" are ways you can help.")])]),x,v,k,l(" more "),_,t("p",null,[e("Nu 0.60 is available as "),t("a",N,[e("pre-built binaries"),n(a)]),e(" or from "),t("a",q,[e("crates.io"),n(a)]),e(". If you have Rust installed you can install it using "),T,e(".")]),$,t("p",null,[e("These come from the "),t("a",A,[e("RFC 3339"),n(a)]),e(" standard for datetime formats.")]),B,t("p",null,[e("We're working to bring the "),t("a",M,[e("book up to date"),n(a)]),e(", and it's a good place to find explanations of these improvements. Be sure to also look at the "),t("a",W,[e("updated command documentation"),n(a)]),e(" for more information on the updated commands.")]),I,t("p",null,[e("We're moving to a new error reporter called "),t("a",S,[e("miette"),n(a)]),e(". It's an attractive way of showing errors back while you're working in the REPL or on scripts.")]),C,O,t("p",null,[e("Nushell has changed its line editor and now it uses "),t("a",R,[e("Reedline"),n(a)]),e(". This new line editor allows for improvements and added functionality to the already awesome Nushell experience. Some of the new improvements are:")]),z,t("p",null,[e("You can find out more on "),t("a",E,[e("the full breaking changes list"),n(a)]),e(".")]),L])}const G=r(b,[["render",D],["__file","2022-03-22-nushell_0_60.html.vue"]]);export{G as default};
