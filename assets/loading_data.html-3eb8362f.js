...
name = &quot;adhoc_derive&quot;
version = &quot;0.1.2&quot;
</code></pre></div><p>&quot;Cargo.lock&quot;ファイルは実際には.toml ファイルですが、ファイル拡張子が.toml ではありません。でも大丈夫です、<code>from toml</code>コマンドが使えます。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">open</span> Cargo.lock <span class="token operator">|</span> from toml <span class="token operator">|</span> table
──────────┬───────────────────
...
license = &quot;MIT&quot;
</code></pre></div><h2 id="url-からの取得" tabindex="-1"><a class="header-anchor" href="#url-からの取得" aria-hidden="true">#</a> URL からの取得</h2><p>ファイルシステムからファイルを読み込むことに加えて、<code>http get</code>コマンドを利用して URL からリソースを取得できます。 これはインターネットから URL の内容をフェッチして返してくれます。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> http get https://blog.rust-lang.org/feed.xml <span class="token operator">|</span> table
╭────────────┬──────────────────╮
│ tag        │ feed             │
...
╰────────────┴──────────────────╯
</code></pre></div>`,44),p=[o];function l(c,i){return a(),e("div",null,p)}const u=n(s,[["render",l],["__file","loading_data.html.vue"]]);export{u as default};
