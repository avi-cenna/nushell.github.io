...
╰───────┴────────────────────╯
</code></pre></div>`,7);function f(e,u){return r(),o("div",null,[a("h1",d,[l,s(),a("code",null,n(e.$frontmatter.title),1),s(" for expression")]),a("div",p,n(e.$frontmatter.expression),1),h])}const _=t(c,[["render",f],["__file","dfr_as.html.vue"]]);export{_ as default};
