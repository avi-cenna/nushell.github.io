import{_ as o,M as l,p as r,q as d,Q as e,t as n,N as a,U as s,a1 as i}from"./framework-344bb0e4.js";const c={},u=e("h1",{id:"laden-von-daten",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#laden-von-daten","aria-hidden":"true"},"#"),n(" Laden von Daten")],-1),p=e("code",null,"ls",-1),m=e("code",null,"ps",-1),h=e("code",null,"date",-1),g=e("code",null,"sys",-1),f=e("h2",{id:"dateien-offnen",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#dateien-offnen","aria-hidden":"true"},"#"),n(" Dateien öffnen")],-1),b=e("code",null,"open",-1),_=i(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">open</span> editors/vscode/package.json <span class="token operator">|</span> table
──────────────────┬───────────────────────────────────────────────────────────────────────────────
 name             │ lark
...
──────────────────┴───────────────────────────────────────────────────────────────────────────────
</code></pre></div>`,1),k=e("code",null,"ls",-1),v=e("code",null,"get",-1),x=i(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; open editors/vscode/package.json | get version
1.0.0
...
───┴──────────────────────────────
</code></pre></div>`,14),w=e("code",null,"split",-1),D=e("code",null,"column",-1),B=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> open people.txt | lines | split column "|"
───┬──────────┬───────────┬───────────
...
───┼──────────┼───────────┼───────────
 ...
 2 │ Antonio  │  Vivaldi  │  Composer
───┴──────────┴───────────┴───────────
`)])],-1),z=e("em",null,"fast",-1),T=e("code",null,"trim",-1),y=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> open people.txt | lines | split column "|" | str trim
───┬─────────┬─────────┬──────────
 # │ column1 │ column2 │ column3
───┼─────────┼─────────┼──────────
 0 │ Octavia │ Butler  │ Writer
 ...
 2 │ Antonio │ Vivaldi │ Composer
───┴─────────┴─────────┴──────────
`)])],-1),j=e("code",null,"split",-1),N=i(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; open people.txt | lines | split column &quot;|&quot; | str trim | get column1
───┬─────────
 0 │ Octavia
 1 │ Bob
 2 │ Antonio
...
───┴────────────┴───────────┴──────────
</code></pre></div><p>Weitere Befehle, mit denen Texte aus Strings bearbeitet werden können sind:</p>`,6),S=e("li",null,[e("code",null,"str")],-1),C=e("code",null,"lines",-1),R=e("code",null,"size",-1),q=i(`<p>Es gibt ausserdem einige Hilfsbefehle, die verwendet werden können um mit Daten umzugehen, die Nu eigentlich verstehen sollte. Zum Beispiel wenn eine Rust lock Datei geöffnet wird:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; open Cargo.lock
# This file is automatically @generated by Cargo.
# It is not intended for manual editing.
[[package]]
name = &quot;adhoc_derive&quot;
version = &quot;0.1.2&quot;
</code></pre></div><p>Eine &quot;Cargo.lock&quot; Datei ist eigentlich eine .toml Datei, aber die Dateiendung ist nicht .toml. Das ist ok, denn mit dem <code>from</code> und seinem Unterbefehl <code>toml</code> können wir dies explizit angeben:</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token function">open</span> Cargo.lock <span class="token operator">|</span> from toml <span class="token operator">|</span> table
──────────┬───────────────────
...
──────────┴───────────────────
</code></pre></div><p>Der <code>from</code> Befehl kann für jedes strukturierte Datenformat, welches Nu versteht, verwendet werden, indem das Format als entsprechender Unterbefehl verwendet wird.</p><h2 id="offnen-im-raw-modus" tabindex="-1"><a class="header-anchor" href="#offnen-im-raw-modus" aria-hidden="true">#</a> Öffnen im raw Modus</h2>`,6),A=e("code",null,"open",-1),V=e("code",null,"--raw",-1),E=e("div",{class:"language-text","data-ext":"text"},[e("pre",{class:"language-text"},[e("code",null,`> open Cargo.toml --raw
[package]                                                                                        name = "nu"
version = "0.1.3"
authors = ["Yehuda Katz <wycats@gmail.com>", "Jonathan Turner <jonathan.d.turner@gmail.com>"]
description = "A shell for the GitHub era"
license = "MIT"
`)])],-1),L=e("h2",{id:"urls-abrufen",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#urls-abrufen","aria-hidden":"true"},"#"),n(" URLs abrufen")],-1),P=e("code",null,"http get",-1),W=i(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> http get https://blog.rust-lang.org/feed.xml <span class="token operator">|</span> table
╭────────────┬──────────────────╮
│ tag        │ feed             │
...
╰────────────┴──────────────────╯
</code></pre></div>`,1);function I(M,U){const t=l("RouterLink");return r(),d("div",null,[u,e("p",null,[n("Im letzten Kapitel wurden Befehle wie "),a(t,{to:"/commands/docs/ls.html"},{default:s(()=>[p]),_:1}),n(", "),a(t,{to:"/commands/docs/ps.html"},{default:s(()=>[m]),_:1}),n(", "),a(t,{to:"/commands/docs/date.html"},{default:s(()=>[h]),_:1}),n(", and "),a(t,{to:"/commands/docs/sys.html"},{default:s(()=>[g]),_:1}),n(" vorgestellt um Informationen über Dateien, Prozesse, Zeiten und die Systemumgebung selber zu laden. Jeder Befehl ergibt eine Tabelle aus, mit der gearbeitet werden kann. Es gibt jedoch noch andere Möglichkeiten Tabellen aus Daten zu erhalten.")]),f,e("p",null,[n("Einer der mächtigsten Befehle in Nu um mir Daten zu arbeite ist der "),a(t,{to:"/commands/docs/open.html"},{default:s(()=>[b]),_:1}),n(" Befehl. Er ist ein Multi-Werkzeug, welcher mit verschiedensten Datenformaten umgehen kann. Hier zum Beispiel was passiert, wenn eine json Datei geöffnet wird:")]),_,e("p",null,[n("Ähnlich wie beim "),a(t,{to:"/commands/docs/ls.html"},{default:s(()=>[k]),_:1}),n(' Befehl, bekommen wir mehr als nur Text (oder einen Stream von bytes) zurück, wenn wir einen Dateityp öffnen, den Nu versteht. Hier wurde ein "package.json" von einem JavaScript Projekt geöffnet. Nu erkennt den json text und parst die Daten in eine Tabelle.')]),e("p",null,[n("Soll nur die Version aus dem Projekt angezeigt werden, kann mit dem "),a(t,{to:"/commands/docs/get.html"},{default:s(()=>[v]),_:1}),n(" direkt diese Information herausgelesen werden.")]),x,e("p",null,[n("Dadurch wird bereits wieder eine Liste ausgegeben. Im nächsten Schritt sollen die Zeilen in etwas brauchbares aufgeteilt werden. Dafür verwenden wir den "),a(t,{to:"/commands/docs/split.html"},{default:s(()=>[w]),_:1}),n(" Befehl. Wie der Name schon verräht, kann damit ein String durch ein Trennzeichen aufgesplittet oder aufgetrennt werden. Mit dem "),D,n(" Unterbefehl wird der Inhalt über mehrere Spalten aufgeteilt. Als Parameter reicht das Trennzeichen, der Rest ist automatisch:")]),B,e("p",null,[n("Das sieht "),z,n(" korrekt aus.Es sieht so aus, als ob sich noch eine zusätzliche Lücke eingeschlichen hat. Mit dem "),a(t,{to:"/commands/docs/str_trim.html"},{default:s(()=>[T]),_:1}),n(" Befehl wird dieser beseitigt:")]),y,e("p",null,[n("Nicht schlecht. Der "),a(t,{to:"/commands/docs/split.html"},{default:s(()=>[j]),_:1}),n(" Befehl gibt nicht nur brauchbare Daten zurück, sondern bezeichnet auch noch standardmässig die Spaltennamen:")]),N,e("ul",null,[S,e("li",null,[a(t,{to:"/commands/docs/lines.html"},{default:s(()=>[C]),_:1})]),e("li",null,[a(t,{to:"/commands/docs/size.html"},{default:s(()=>[R]),_:1})])]),q,e("p",null,[n("Auch wenn es hilfreich ist, beim Öffnen einer Datei direkt eine Tabelle zu erhalten, ist dies nicht immer gewünscht. Um den darunter liegenden Text zu erhalten, kann dem "),a(t,{to:"/commands/docs/open.html"},{default:s(()=>[A]),_:1}),n(" Befehl das Flag "),V,n(" mitgegeben werden:")]),E,L,e("p",null,[n("Zusätzlich zum Laden von Dateien vom Dateisystem, können auch URLs mit dem "),a(t,{to:"/commands/docs/fetch.html"},{default:s(()=>[P]),_:1}),n(" Befehl geladen werden. Dies wird den Inhalt der URL aus dem Netz abrufen und zurückgeben:")]),W])}const Z=o(c,[["render",I],["__file","loading_data.html.vue"]]);export{Z as default};
