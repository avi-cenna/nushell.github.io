...
&gt; hello
</code></pre></div><p>The name of the module follows the same rule as module created from a file: Stem of the directory name, i.e., the directory name, is used as the module name. Again, you could do this as a two-step action using <code>module</code> and <code>use</code> separately, as explained in the previous section.</p>`,29),h={class:"custom-container tip"},m=e("p",{class:"custom-container-title"},"You can define `main` command inside `mod.nu` to create a command named after the module directory. :::",-1),p=e("h2",{id:"import-pattern",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#import-pattern","aria-hidden":"true"},"#"),o(" Import Pattern")],-1),g=e("code",null,"use",-1),f=e("strong",null,"import pattern",-1),x=e("code",null,"use head members...",-1),v=e("code",null,"head",-1),y=i(`<p>Using our <code>greetings</code> example:</p><p><code>use greetings</code></p><p>Imports all symbols with prefixed with the <code>greetings</code> namespace (can call <code>greetings hello</code> and <code>greetings hi</code>).</p><p><code>use greetings hello</code></p><p>The <code>hello</code> command will be imported directly without any prefix.</p><p><code>use greetings [ hello, hi ]</code></p><p>Imports multiple definitions&lt;&gt; directly without any prefix.</p><p><code>use greetings *</code></p><p>You can also use the module name and the <code>*</code> glob to import all names directly without any prefix.</p><h2 id="main" tabindex="-1"><a class="header-anchor" href="#main" aria-hidden="true">#</a> <code>main</code></h2><p>Exporting a command called <code>main</code> from a module defines a command named as the module. Let&#39;s extend our <code>greetings</code> example:</p><div class="language-nushell" data-ext="nushell"><pre class="language-nushell"><code># greetings.nu
...
`)])],-1),_=e("code",null,"use",-1),q=e("code",null,"export-env",-1),k=i(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; use greetings.nu
...
</code></pre></div><p>Only <code>$env.TMP_LEN</code> and <code>$env.OTHER_ENV</code> are preserved after evaluating the <code>export-env</code> module.</p></div>`,2),$=e("h2",{id:"caveats",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#caveats","aria-hidden":"true"},"#"),o(" Caveats")],-1),T=e("p",null,"Like any programming language, Nushell is also a product of a tradeoff and there are limitations to our module system.",-1),M=e("h3",{id:"export-env-runs-only-when-the-use-call-is-evaluated",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#export-env-runs-only-when-the-use-call-is-evaluated","aria-hidden":"true"},"#"),o(),e("code",null,"export-env"),o(" runs only when the "),e("code",null,"use"),o(" call is "),e("em",null,"evaluated")],-1),N=e("code",null,"export use",-1),A=i(`<div class="language-nushell" data-ext="nushell"><pre class="language-nushell"><code># purpose.nu
export-env {
...
`)])],-1),S=e("code",null,"hide",-1),H=e("code",null,"use",-1),L=i("<p><code>hide foo</code> or <code>hide greetings</code></p><ul><li>If the name is a custom command or an environment variable, hides it directly. Otherwise:</li><li>If the name is a module name, hides all of its exports prefixed with the module name</li></ul><p><code>hide greetings hello</code></p><ul><li>Hides only the prefixed command / environment variable</li></ul><p><code>hide greetings [hello, hi]</code></p><ul><li>Hides only the prefixed commands / environment variables</li></ul><p><code>hide greetings *</code></p><ul><li>Hides all of the module&#39;s exports, without the prefix</li></ul><p><em>Note: <code>hide</code> is not a supported keyword at the root of the module (unlike <code>def</code> etc.)</em></p>",9);function O(R,U){const n=l("RouterLink");return s(),r("div",null,[c,e("div",h,[m,p,e("p",null,[o("Anything after the "),t(n,{to:"/commands/docs/use.html"},{default:d(()=>[g]),_:1}),o(" keyword forms an "),f,o(" which controls how the definitions are imported. The import pattern has the following structure "),x,o(" where "),v,o(" defines the module (name of an existing module, file, or directory). The members are optional and specify what exactly should be imported from th emodule.")]),y,e("p",null,[o("Modules can also define an environment using "),t(n,{to:"/commands/docs/export-env.html"},{default:d(()=>[b]),_:1}),o(":")]),w,e("p",null,[o("When "),t(n,{to:"/commands/docs/use.html"},{default:d(()=>[_]),_:1}),o(" is evaluated, it will run the code inside the "),t(n,{to:"/commands/docs/export-env.html"},{default:d(()=>[q]),_:1}),o(" block and merge its environment into the current scope:")]),k]),$,T,M,e("p",null,[o("If you also want to keep your variables in separate modules and export their environment, you could try to "),t(n,{to:"/commands/docs/export_use.html"},{default:d(()=>[N]),_:1}),o(" it:")]),A,e("p",null,[o("Anything defined in a module without the "),t(n,{to:"/commands/docs/export.html"},{default:d(()=>[E]),_:1}),o(" keyword will work only in the module's scope.")]),I,e("p",null,[o('Any custom command or alias, imported from a module or not, can be "hidden", restoring the previous definition. We do this with the '),t(n,{to:"/commands/docs/hide.html"},{default:d(()=>[P]),_:1}),o(" command:")]),Y,e("p",null,[o("The "),t(n,{to:"/commands/docs/hide.html"},{default:d(()=>[S]),_:1}),o(" command also accepts import patterns, just like "),t(n,{to:"/commands/docs/use.html"},{default:d(()=>[H]),_:1}),o(". The import pattern is interpreted slightly differently, though. It can be one of the following:")]),L])}const B=a(u,[["render",O],["__file","modules.html.vue"]]);export{B as default};
