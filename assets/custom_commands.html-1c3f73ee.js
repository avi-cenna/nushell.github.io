...
<span class="token punctuation">}</span>
  ...
  print <span class="token string">&quot;hello all:&quot;</span>
...
greet earth mars jupiter venus
  ...
  print $<span class="token string">&quot;hello to our VIP (<span class="token variable">$vip</span>)&quot;</span>
  print <span class="token string">&quot;and hello to everybody else:&quot;</span>
  <span class="token keyword">for</span> <span class="token variable">$n</span> <span class="token keyword">in</span> <span class="token variable">$name</span> <span class="token punctuation">{</span>
    <span class="token builtin class-name">echo</span> <span class="token variable">$n</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
</code></pre></div>`,92),u=n("code",null,"ls",-1),g=p(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code>def my-ls <span class="token punctuation">[</span><span class="token punctuation">]</span> <span class="token punctuation">{</span> <span class="token function">ls</span> <span class="token punctuation">}</span>
</code></pre></div>`,1),h=n("code",null,"ls",-1),k=p(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; my-ls | get name
───┬───────────────────────
 0 │ myscript.nu
 1 │ myscript2.nu
...
───┴─────
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="持久化" tabindex="-1"><a class="header-anchor" href="#持久化" aria-hidden="true">#</a> 持久化</h2>`,11);function m(b,v){const s=c("RouterLink");return l(),i("div",null,[r,n("p",null,[a("让我们把"),e(s,{to:"/commands/docs/ls.html"},{default:t(()=>[u]),_:1}),a("移到我们编写的命令中：")]),g,n("p",null,[a("我们就可以像使用"),e(s,{to:"/commands/docs/ls.html"},{default:t(()=>[h]),_:1}),a("一样使用这个命令的输出：")]),k,n("p",null,[a("关于如何持久化自定义命令，以便在你启动 Nushell 时它们是可用的，请参阅 "),e(s,{to:"/zh-CN/book/configuration.html"},{default:t(()=>[a("配置")]),_:1}),a(" 部分并添加你的启动脚本。")])])}const f=o(d,[["render",m],["__file","custom_commands.html.vue"]]);export{f as default};
