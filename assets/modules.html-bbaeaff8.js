...
&gt; hello
</code></pre></div><p>The name of the module follows the same rule as module created from a file: Stem of the directory name, i.e., the directory name, is used as the module name. Again, you could do this as a two-step action using <code>module</code> and <code>use</code> separately, as explained in the previous section.</p><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>You can define <code>main</code> command inside <code>mod.nu</code> to create a command named after the module directory.</p></div><h2 id="import-pattern" tabindex="-1"><a class="header-anchor" href="#import-pattern" aria-hidden="true">#</a> Import Pattern</h2>`,31),h=e("code",null,"use",-1),m=e("strong",null,"import pattern",-1),p=e("code",null,"use head members...",-1),g=e("code",null,"head",-1),f=a(`<p>Using our <code>greetings</code> example:</p><div class="language-text" data-ext="text"><pre class="language-text"><code>use greetings
</code></pre></div><p>imports all symbols prefixed with the <code>greetings</code> namespace (can call <code>greetings hello</code> and <code>greetings hi</code>).</p><div class="language-text" data-ext="text"><pre class="language-text"><code>use greetings hello
</code></pre></div><p>will import the <code>hello</code> command directly without any prefix.</p><div class="language-text" data-ext="text"><pre class="language-text"><code>use greetings [hello, hi]
</code></pre></div><p>imports multiple definitions&lt;&gt; directly without any prefix.</p><div class="language-text" data-ext="text"><pre class="language-text"><code>use greetings *
</code></pre></div><p>will import all names directly without any prefix.</p><h2 id="main" tabindex="-1"><a class="header-anchor" href="#main" aria-hidden="true">#</a> <code>main</code></h2><p>Exporting a command called <code>main</code> from a module defines a command named as the module. Let&#39;s extend our <code>greetings</code> example:</p><div class="language-nushell" data-ext="nushell"><pre class="language-nushell"><code># greetings.nu
...
`)])],-1),b=e("code",null,"use",-1),y=e("code",null,"export-env",-1),w=a(`<div class="language-text" data-ext="text"><pre class="language-text"><code>&gt; use greetings.nu
