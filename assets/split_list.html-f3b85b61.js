...
</code></pre></div><p>Split a list of chars into lists based on multiple characters</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token operator">&gt;</span> <span class="token punctuation">[</span>a, b, c, d, a, e, f, g<span class="token punctuation">]</span> <span class="token operator">|</span> <span class="token function">split</span> list <span class="token parameter variable">-r</span> <span class="token string">&#39;(b|e)&#39;</span>
╭───┬───────────╮
│ <span class="token number">0</span> │ ╭───┬───╮ │
│   │ │ <span class="token number">0</span> │ a │ │
│   │ ╰───┴───╯ │
...
│   │ │ <span class="token number">0</span> │ f │ │
│   │ │ <span class="token number">1</span> │ g │ │
│   │ ╰───┴───╯ │
╰───┴───────────╯

</code></pre></div>`,13);function d(s,b){return p(),o("div",null,[n("h1",r,[i,a(),n("code",null,e(s.$frontmatter.title),1),a(" for filters")]),n("div",u,e(s.$frontmatter.filters),1),k])}const h=t(l,[["render",d],["__file","split_list.html.vue"]]);export{h as default};
